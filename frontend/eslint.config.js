...
const RESTRICT_ENQUEUE = {
  selector:
    "CallExpression[callee.object.name='API'][callee.property.name=/^(generateStoryboard|generateVideo|generateNarrationAudio|generateEpisodeNarrationAudio|generateCharacter|generateCharacterDerivative|generateCharacterVoiceSample|generateProjectScene|generateProjectProp|generateProjectProduct|editImage|generateGrid|regenerateGrid|generateReferenceVideoUnit|generateReferenceVideoBatch|composeReferenceVideoEpisode)$/]",
  message:
