...
export default {
  ...
  'reference_overview_open': 'Xem toàn bộ kịch bản',
  'reference_overview_title': 'Xem toàn bộ kịch bản',
  'reference_overview_summary': '{{count}} đơn vị video · ~{{seconds}} giây',
  'reference_overview_close': 'Đóng xem toàn bộ kịch bản',
  'reference_overview_copy_all': 'Sao chép tất cả',
  'reference_overview_download': 'Tải xuống .txt',
  'reference_overview_copy_success': 'Đã sao chép toàn bộ kịch bản vào clipboard',
  'reference_overview_copy_failed': 'Sao chép thất bại, vui lòng tự chọn văn bản',
  ...
  'reference_unit_move_earlier': 'Di chuyển đơn vị lên trước',
  'reference_unit_move_later': 'Di chuyển đơn vị ra sau',
  'reference_unit_move_failed': 'Sắp xếp lại đơn vị thất bại: {{message}}',
  'reference_unit_insert_before': 'Chèn đơn vị trước',
  'reference_unit_insert_after': 'Chèn đơn vị sau',
  'reference_unit_delete_title': 'Xóa đơn vị',
  'reference_unit_delete_confirm': 'Xóa đơn vị {{id}}? Video đã tạo cũng sẽ bị xóa. Không thể hoàn tác.',
  'reference_unit_deleting': 'Đang xóa…',
  'reference_unit_delete_failed': 'Xóa thất bại: {{message}}',
  'reference_compose_cta': 'Ghép thành phẩm',
  'reference_compose_not_ready': 'Còn đơn vị chưa có video, không thể ghép thành phẩm',
  'reference_compose_rendering': 'Đang ghép thành phẩm…',
  'reference_compose_preview_label': 'Xem trước thành phẩm',
  'reference_compose_download': 'Tải thành phẩm',
  'reference_compose_task_submitted_toast': 'Đã gửi yêu cầu ghép thành phẩm',
  'reference_compose_failed': 'Ghép thành phẩm thất bại: {{error}}',
