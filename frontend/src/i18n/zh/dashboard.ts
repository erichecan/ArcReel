...
export default {
  ...
  'reference_overview_open': '整稿预览',
  'reference_overview_title': '整稿预览',
  'reference_overview_summary': '{{count}} 个视频单元 · 约 {{seconds}} 秒',
  'reference_overview_close': '关闭整稿预览',
  'reference_overview_copy_all': '复制全文',
  'reference_overview_download': '下载 .txt',
  'reference_overview_copy_success': '已复制全文到剪贴板',
  'reference_overview_copy_failed': '复制失败，请手动选取文本',
  ...
  'reference_unit_move_earlier': '前移单元',
  'reference_unit_move_later': '后移单元',
  'reference_unit_move_failed': '调整单元顺序失败：{{message}}',
  'reference_unit_insert_before': '在此单元前插入',
  'reference_unit_insert_after': '在此单元后插入',
  'reference_unit_delete_title': '删除单元',
  'reference_unit_delete_confirm': '确定要删除单元 {{id}} 吗？已生成的成片会一并删除，此操作不可撤销。',
  'reference_unit_deleting': '删除中…',
  'reference_unit_delete_failed': '删除失败：{{message}}',
  'reference_compose_cta': '一键成片',
  'reference_compose_not_ready': '还有单元没有生成成片，无法一键成片',
  'reference_compose_rendering': '正在合成成片…',
  'reference_compose_preview_label': '成片预览',
  'reference_compose_download': '下载成片',
  'reference_compose_task_submitted_toast': '已提交一键成片任务',
  'reference_compose_failed': '一键成片失败：{{error}}',
