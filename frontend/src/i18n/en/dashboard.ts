...
export default {
  ...
  'reference_overview_open': 'Script overview',
  'reference_overview_title': 'Script overview',
  'reference_overview_summary': '{{count}} video units · ~{{seconds}}s',
  'reference_overview_close': 'Close script overview',
  'reference_overview_copy_all': 'Copy all',
  'reference_overview_download': 'Download .txt',
  'reference_overview_copy_success': 'Copied the full script to the clipboard',
  'reference_overview_copy_failed': 'Copy failed — please select the text manually',
  ...
  'reference_unit_move_earlier': 'Move unit earlier',
  'reference_unit_move_later': 'Move unit later',
  'reference_unit_move_failed': 'Failed to reorder units: {{message}}',
  'reference_unit_insert_before': 'Insert unit before',
  'reference_unit_insert_after': 'Insert unit after',
  'reference_unit_delete_title': 'Delete unit',
  'reference_unit_delete_confirm': 'Delete unit {{id}}? Its generated video will be removed too. This cannot be undone.',
  'reference_unit_deleting': 'Deleting…',
  'reference_unit_delete_failed': 'Delete failed: {{message}}',
  'reference_compose_cta': 'Compose episode',
  'reference_compose_not_ready': 'Some units have no clip yet, cannot compose',
  'reference_compose_rendering': 'Composing…',
  'reference_compose_preview_label': 'Final cut preview',
  'reference_compose_download': 'Download final cut',
  'reference_compose_task_submitted_toast': 'Compose task submitted',
  'reference_compose_failed': 'Compose failed: {{error}}',
