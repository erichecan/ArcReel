MESSAGES = {
    ...
    "ad_asset_plan_confirmation_requires_assets": "Chưa đăng ký nhân vật, bối cảnh hoặc đạo cụ nào — hãy đăng ký ít nhất một, hoặc xác nhận rõ ràng rằng dự án này không cần thêm tài nguyên",
